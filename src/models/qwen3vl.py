...
class Qwen3VL(BaseModel):
    """Qwen3-VL wrapper for training with xtuner: LoRA, special tokens and loss forward."""
    ...
    def __init__(
        ...
        # bfloat16 with FlashAttention-2 by default; PANORAMA_ATTN_IMPL=sdpa switches to
        # PyTorch attention (no flash-attn install, or a GPU-less checkpoint conversion).
    ...
    def forward(self,
        ...
        # Qwen3-VL computes its own M-RoPE positions.
        output = self.model(
            ...
            # hidden states feed the [SEG] bridge
    ...
    def state_dict(self, *args, **kwargs):
        # Only the LoRA and modules_to_save weights when LoRA is on.
