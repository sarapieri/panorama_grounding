...
from third_parts.sam3_concept.sam.rope import apply_rotary_enc, apply_rotary_enc_real, compute_axial_cis
...
class Attention(nn.Module):
    ...
    def forward(self, q: Tensor, k: Tensor, v: Tensor) -> Tensor:
        ...
        if self.use_fa3:
            from third_parts.sam3_concept.perflib.fa3 import flash_attn_func
