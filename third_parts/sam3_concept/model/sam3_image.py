...
import numpy as np
import torch
from third_parts.sam3_concept.model.model_misc import SAM3Output
from third_parts.sam3_concept.model.vl_combiner import SAM3VLBackbone
from third_parts.sam3_concept.perflib.nms import nms_masks
from third_parts.sam3_concept.model.data_misc import BatchedDatapoint
...
class Sam3Image(torch.nn.Module):
    ...
    def __init__(
        ...
        inst_interactive_predictor=None,  # interactive predictor not vendored
        **kwargs,
    ):
        super().__init__()
