...
class Attention(nn.Module):
    ...
    def _setup_rope_freqs(self) -> None:
        ...
        # Non-persistent: the RoPE cache is deterministic and recomputed at construction;
        # persisting it would serialize a complex64 buffer that safetensors cannot load.
